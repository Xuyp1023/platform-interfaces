...
public class CustMechLawTmp implements BetterjrEntity, ICustAuditEntityFace {
    ...
    public boolean equals(final Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getMartialStatus() == null ? other.getMartialStatus() == null
                        : this.getMartialStatus().equals(other.getMartialStatus()))
    ...
    public void initModifyValue(final CustMechLawTmp anCustMechLawTmp) {
        ...
        this.eduLevel = anCustMechLawTmp.getEduLevel();
        this.identNo = anCustMechLawTmp.getIdentNo();
        this.identType = anCustMechLawTmp.getIdentType();
        this.martialStatus = anCustMechLawTmp.getMartialStatus();
        this.name = anCustMechLawTmp.getName();
        this.nativePlace = anCustMechLawTmp.getNativePlace();
