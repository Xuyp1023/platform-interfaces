...
@Entity
@Table(name = "t_cust_mech_base")
public class CustMechBase implements BetterjrEntity {
    /**
     * 客户编号
     */
    @Id
    ...
    private static final long serialVersionUID = 1468812783854L;
    ...
    public void setCorpType(final String anCorpType) {
        corpType = anCorpType;
    }
    ...
    public void setNationType(final String nationType) {
    ...
    public void setCapitalType(final String capitalType) {
    ...
    public void setLawPhone(final String lawPhone) {
    ...
    public void setCorpVocation(final String corpVocation) {
    ...
    public void setCorpProperty(final String corpProperty) {
    ...
    public void setInvest(final String invest) {
    ...
    public void setPremisesType(final String premisesType) {
    ...
    public void setAddress(final String anAddress) {
        address = anAddress;
    }
    ...
    public void setWebaddr(final String webaddr) {
    ...
    public boolean equals(final Object that) {
        ...
        final CustMechBase other = (CustMechBase) that;
        return (this.getCustNo() == null ? other.getCustNo() == null : this.getCustNo().equals(other.getCustNo()))
                ...
                && (this.getCorpType() == null ? other.getCorpType() == null
                        : this.getCorpType().equals(other.getCorpType()))
                && (this.getNationType() == null ? other.getNationType() == null
                        : this.getNationType().equals(other.getNationType()))
                && (this.getCapitalType() == null ? other.getCapitalType() == null
                        : this.getCapitalType().equals(other.getCapitalType()))
                ...
                && (this.getRegAddress() == null ? other.getRegAddress() == null
                        : this.getRegAddress().equals(other.getRegAddress()))
                && (this.getCorpVocation() == null ? other.getCorpVocation() == null
                        : this.getCorpVocation().equals(other.getCorpVocation()))
                ...
                && (this.getPremisesArea() == null ? other.getPremisesArea() == null
                        : this.getPremisesArea().equals(other.getPremisesArea()))
                && (this.getPremisesYear() == null ? other.getPremisesYear() == null
                        : this.getPremisesYear().equals(other.getPremisesYear()))
                && (this.getPremisesType() == null ? other.getPremisesType() == null
                        : this.getPremisesType().equals(other.getPremisesType()))
                && (this.getPremisesAddress() == null ? other.getPremisesAddress() == null
                        : this.getPremisesAddress().equals(other.getPremisesAddress()))
                && (this.getBusinScope() == null ? other.getBusinScope() == null
                        : this.getBusinScope().equals(other.getBusinScope()))
    ...
    public void initAddValue(final Long anCustNo) {
    ...
    public void initModifyValue(final CustMechBase anCustMechBase) {
        //
    ...
    // 将临时表数据转入正式表
    public void initModifyValue(final CustMechBaseTmp anMechBaseTmp) {
        ...
        this.corpProperty = anMechBaseTmp.getCorpProperty();
        this.corpVocation = anMechBaseTmp.getCorpVocation();
        this.custClass = anMechBaseTmp.getCustClass();
        this.email = anMechBaseTmp.getEmail();
        this.fax = anMechBaseTmp.getFax();
        this.instType = anMechBaseTmp.getInstType();
        this.invest = anMechBaseTmp.getInvest();
        this.lawIdentNo = anMechBaseTmp.getLawIdentNo();
        this.lawIdentType = anMechBaseTmp.getLawIdentType();
        this.lawName = anMechBaseTmp.getLawName();
        this.lawPhone = anMechBaseTmp.getLawPhone();
        ...
        this.premisesAddress = anMechBaseTmp.getPremisesAddress();
        this.premisesArea = anMechBaseTmp.getPremisesArea();
        this.premisesType = anMechBaseTmp.getPremisesType();
        this.premisesYear = anMechBaseTmp.getPremisesYear();
        this.qq = anMechBaseTmp.getQq();
        this.regAddress = anMechBaseTmp.getRegAddress();
