...
public class CustMechBase implements BetterjrEntity {
    ...
    public void initModifyValue(CustMechBase anCustMechBase) {
        this.custNo = anCustMechBase.getCustNo();

/*        this.regOperId = anCustMechBase.getRegOperId();
        this.regOperName = anCustMechBase.getRegOperName();
        this.regDate = anCustMechBase.getRegDate();
        this.regTime = anCustMechBase.getRegTime();*/
        ...
        this.businStatus = anCustMechBase.getBusinStatus();
        this.operOrg = anCustMechBase.getOperOrg();
    }
}