...
@Entity
@Table(name = "t_cust_mech_law")
public class CustMechLaw implements BetterjrEntity {
    /**
     * 编号
     */
    @Id
    ...
    public void initModifyValue(final CustMechLawTmp anMechLawTmp) {
        ...
        this.eduLevel = anMechLawTmp.getEduLevel();
        this.identNo = anMechLawTmp.getIdentNo();
        this.identType = anMechLawTmp.getIdentType();
        this.martialStatus = anMechLawTmp.getMartialStatus();
        this.name = anMechLawTmp.getName();
        this.nativePlace = anMechLawTmp.getNativePlace();
