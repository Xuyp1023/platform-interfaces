...
public interface ICustInsteadService {
     ...
     * @return
     */
    public String webQueryInsteadApplyReviewList(Map<String, Object> anParam, int anFlag, int anPageNum,
            int anPageSize);
     ...
     * @return
     */
    public String webQueryInsteadApplyConfirmList(Map<String, Object> anParam, int anFlag, int anPageNum,
            int anPageSize);
