...
public class CustFlowMoney implements BetterjrEntity {
    ...
    public boolean isContain(BigDecimal in){
    	...
    	if(this.auditMinAmount.compareTo(in)==-1 && (this.auditMaxAmount.compareTo(in)==0 || this.auditMaxAmount.compareTo(in)>0)){
    		return true;
    	}
    	return false;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getAuditMinAmount() == null ? other.getAuditMinAmount() == null : this.getAuditMinAmount().equals(other.getAuditMinAmount()))
            && (this.getAuditMaxAmount() == null ? other.getAuditMaxAmount() == null : this.getAuditMaxAmount().equals(other.getAuditMaxAmount()))
            && (this.getAduitAll() == null ? other.getAduitAll() == null : this.getAduitAll().equals(other.getAduitAll()));
    }
